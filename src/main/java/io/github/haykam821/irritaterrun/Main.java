...
public class Main implements ModInitializer {
	...
	public static final GameType<IrritaterRunConfig> IRRITATER_RUN_TYPE = GameType.register(IRRITATER_RUN_ID, IrritaterRunWaitingPhase::open, IrritaterRunConfig.CODEC);
